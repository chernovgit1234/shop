								...
								<ul class="social-footer">
									<li class="social-footer__item">
										<a href="" class="social-footer__link">
											<img :src="require('../img/icons/social/facebook.png')" alt="img">
										</a>
									</li>
									<li class="social-footer__item">
										<a href="" class="social-footer__link">
											<img :src="require('../img/icons/social/telegram.png')" alt="img">
										</a>
									</li>
									<li class="social-footer__item">
										<a href="" class="social-footer__link">
											<img :src="require('../img/icons/social/viber.png')" alt="img">
										</a>
									</li>
									<li class="social-footer__item">
										<a href="" class="social-footer__link">
											<img :src="require('../img/icons/social/whatsapp.png')" alt="img">
										</a>
									</li>
								</ul>
							</div>
